const mockdata = require('../../../../jsonSchemaFaker/jsonSchemaFaker.js'); //sets the varible mockdata to our js file
require("regenerator-runtime/runtime");

describe("Test jsonSchemaFaker.js", () => {
    //sets schemas to veibles for us to test
    var property = require('../../../api/property/documentation/1.0.0/property.json')
    var domain = require('../../../api/domain/documentation/1.0.0/domain.json')
